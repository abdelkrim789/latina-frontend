...
var ProductCard = function ProductCard(_ref2) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "product-badge ".concat(_typeof(badge) === "object" ? badge.kind || "" : "")
  }, _typeof(badge) === "object" ? badge.text : badge), /*#__PURE__*/React.createElement("button", {
    type: "button",
...
var QuickView = function QuickView(_ref11) {
  ...
  var handleRestock = /*#__PURE__*/function () {
    var _ref12 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(e) {
      ...
      return _regenerator().w(function (_context) {
        while (1) switch (_context.p = _context.n) {
          case 0:
            e.preventDefault();
            phone = (_phoneRef$current = phoneRef.current) === null || _phoneRef$current === void 0 || (_phoneRef$current = _phoneRef$current.value) === null || _phoneRef$current === void 0 ? void 0 : _phoneRef$current.trim();
            if (phone) {
              _context.n = 1;
              break;
            }
          ...
          case 1:
            _context.p = 1;
            _context.n = 2;
            return window.latinaApi.restockAlert({
              product_id: product.id,
              variant_id: (selectedVariant === null || selectedVariant === void 0 ? void 0 : selectedVariant.id) || undefined,
              phone: phone
            });
          case 2:
            _context.n = 4;
    ...
    return function handleRestock(_x) {
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, colorGroups.map(function (_ref13) {
    var c = _ref13.color,
      hasStock = _ref13.hasStock;
    return /*#__PURE__*/React.createElement("button", {
      key: c,
      type: "button",
    ...
    className: "qv-sizes"
  }, sizesForColor.map(function (_ref14) {
    var s = _ref14.size,
      st = _ref14.stock,
      id = _ref14.id;
    return /*#__PURE__*/React.createElement("button", {
...
var SegmentToggle = function SegmentToggle(_ref15) {
...
var WhatsAppFloat = function WhatsAppFloat(_ref16) {
  var _ref16$lang = _ref16.lang,
    lang = _ref16$lang === void 0 ? "fr" : _ref16$lang,
    _ref16$phone = _ref16.phone,
    phone = _ref16$phone === void 0 ? "+213500000000" : _ref16$phone;
  var t = {
    fr: {
...
var CodTrustStrip = function CodTrustStrip(_ref17) {
...
var RecentlyViewedStrip = function RecentlyViewedStrip(_ref18) {
  var items = _ref18.items,
    onAdd = _ref18.onAdd,
    onQuickView = _ref18.onQuickView,
    _ref18$lang = _ref18.lang,
...
var WilayaSelector = function WilayaSelector(_ref19) {
  var _wilaya$stop_desk2, _wilaya$stop_desk3;
  var _ref19$lang = _ref19.lang,
    lang = _ref19$lang === void 0 ? "fr" : _ref19$lang,
