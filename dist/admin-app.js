(() => {
  ...
  var ProductModal = ({ product, onClose, onSaved }) => {
    ...
    const saveVariant = async () => {
      ...
      try {
        ...
        if (editingVariantId) {
          ...
          savedVariantId = editingVariantId;
          setEditingVariantId(null);
        } else {
          const res = await latinaApi.admin.post(`/products/${effectiveId}/variants`, vForm);
          setVariants((vs) => [...vs, res]);
          savedVariantId = res.id;
          setAddingVariant(false);
        }
        if (vImageFile && savedVariantId) {
          const token = localStorage.getItem("latina-admin-token");
          const root = window.LATINA_API_BASE || "http://localhost:8000/api";
          const fd = new FormData();
          fd.append("image", vImageFile);
          try {
            await fetch(`${root}/admin/variants/${savedVariantId}/image`, {
              method: "POST",
              headers: { Authorization: `Bearer ${token}`, Accept: "application/json" },
              body: fd
            });
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "admin-modal-overlay", onClick: onClose }, /* @__PURE__ */ React.createElement("div", { className: "pm-modal", onClick: (e) => e.stopPropagation() }, /* @__PURE__ */ React.createElement("div", { className: "pm-header" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "pm-header-title" }, isNew ? t("Nouveau produit") : form.name_fr || t("Nouveau produit")), !isNew && form.sku && /* @__PURE__ */ React.createElement("div", { className: "pm-header-sku" }, form.sku)), /* @__PURE__ */ React.createElement("div", { className: "pm-header-actions" }, !isNew && /* @__PURE__ */ React.createElement("div", { className: "pm-tabs" }, /* @__PURE__ */ React.createElement("button", { className: `pm-tab ${tab === "form" ? "active" : ""}`, onClick: () => setTab("form") }, t("Informations")), /* @__PURE__ */ React.createElement("button", { className: `pm-tab ${tab === "variants" ? "active" : ""}`, onClick: () => {
    ...
    )), isNew && (!form.name_fr.trim() || !form.price) && /* @__PURE__ */ React.createElement("div", { style: { textAlign: "right", fontSize: 11, color: "var(--rose)", marginTop: 4, opacity: 0.85 } }, !form.name_fr.trim() ? "\u26A0 Nom en fran\xE7ais requis" : "\u26A0 Prix requis"))), tab === "variants" && effectiveId && /* @__PURE__ */ React.createElement("div", { className: "pm-body pm-body-flat" }, loadingVariants ? /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "center", padding: 40 } }, /* @__PURE__ */ React.createElement("span", { className: "admin-spinner" })) : /* @__PURE__ */ React.createElement(React.Fragment, null, variants.length > 0 && /* @__PURE__ */ React.createElement("div", { style: { overflowX: "auto", marginBottom: 16 } }, /* @__PURE__ */ React.createElement("table", { className: "admin-table" }, /* @__PURE__ */ React.createElement("thead", null, /* @__PURE__ */ React.createElement("tr", null, /* @__PURE__ */ React.createElement("th", null, "Image"), /* @__PURE__ */ React.createElement("th", null, "Couleur"), /* @__PURE__ */ React.createElement("th", null, "Taille"), /* @__PURE__ */ React.createElement("th", null, "SKU"), /* @__PURE__ */ React.createElement("th", { className: "t-right" }, "Stock"), /* @__PURE__ */ React.createElement("th", { className: "t-right" }, "Ajust. DA"), /* @__PURE__ */ React.createElement("th", null, "\xC9tat"), /* @__PURE__ */ React.createElement("th", null))), /* @__PURE__ */ React.createElement("tbody", null, variants.map((v) => editingVariantId === v.id ? /* @__PURE__ */ React.createElement("tr", { key: v.id, style: { background: "var(--bg-2)" } }, /* @__PURE__ */ React.createElement("td", { style: { width: 52 } }, /* @__PURE__ */ React.createElement("label", { title: "Photo de cette couleur", style: { display: "flex", alignItems: "center", justifyContent: "center", width: 40, height: 40, border: "1px dashed var(--border2)", borderRadius: 6, cursor: "pointer", overflow: "hidden", position: "relative" } }, vImagePreview ? /* @__PURE__ */ React.createElement("img", { src: vImagePreview, style: { width: "100%", height: "100%", objectFit: "cover" } }) : (() => {
      const vImg = savedImages.find((m) => m.variant_id === v.id);
      return vImg ? /* @__PURE__ */ React.createElement("img", { src: window.mediaUrl(vImg.url), style: { width: "100%", height: "100%", objectFit: "cover" } }) : /* @__PURE__ */ React.createElement("span", { style: { color: "var(--text-3)", fontSize: 18 } }, "+");
    })(), /* @__PURE__ */ React.createElement("input", { type: "file", accept: "image/*", style: { display: "none" }, onChange: (e) => {
      const f = e.target.files?.[0];
      if (!f) return;
      setVImageFile(f);
      setVImagePreview(URL.createObjectURL(f));
    } }))), /* @__PURE__ */ React.createElement("td", null, /* @__PURE__ */ React.createElement("select", { className: "admin-input", style: { width: 110 }, value: vForm.color, onChange: (e) => setV("color", e.target.value) }, /* @__PURE__ */ React.createElement("option", { value: "" }, "\u2014"), Object.keys(COLOR_HEX).map((c) => /* @__PURE__ */ React.createElement("option", { key: c, value: c }, c)))), /* @__PURE__ */ React.createElement("td", null, /* @__PURE__ */ React.createElement("input", { className: "admin-input", style: { width: 70 }, value: vForm.size, onChange: (e) => setV("size", e.target.value), placeholder: "36" })), /* @__PURE__ */ React.createElement("td", { className: "t-mono", style: { fontSize: 11, color: "var(--text-3)" } }, v.sku), /* @__PURE__ */ React.createElement("td", null, /* @__PURE__ */ React.createElement("input", { className: "admin-input t-num", type: "number", style: { width: 70 }, value: vForm.stock, min: 0, onChange: (e) => setV("stock", Number(e.target.value)) })), /* @__PURE__ */ React.createElement("td", null, /* @__PURE__ */ React.createElement("input", { className: "admin-input t-num", type: "number", style: { width: 80 }, value: vForm.price_adjustment, onChange: (e) => setV("price_adjustment", Number(e.target.value)) })), /* @__PURE__ */ React.createElement("td", null, /* @__PURE__ */ React.createElement("label", { className: "toggle-wrap" }, /* @__PURE__ */ React.createElement("input", { type: "checkbox", checked: vForm.is_active, onChange: (e) => setV("is_active", e.target.checked) }), /* @__PURE__ */ React.createElement("span", { className: "toggle-track" }))), /* @__PURE__ */ React.createElement("td", null, /* @__PURE__ */ React.createElement("div", { className: "gap-row" }, /* @__PURE__ */ React.createElement("button", { className: "btn btn-sm btn-rose", onClick: saveVariant }, "\u2713"), /* @__PURE__ */ React.createElement("button", { className: "btn btn-sm btn-ghost", onClick: () => {
      setEditingVariantId(null);
      setVForm(emptyVForm);
      setVImageFile(null);
      setVImagePreview("");
    } }, "\u2715")))) : /* @__PURE__ */ React.createElement("tr", { key: v.id }, /* @__PURE__ */ React.createElement("td", { style: { width: 52 } }, (() => {
      const vImg = savedImages.find((m) => m.variant_id === v.id);
      return vImg ? /* @__PURE__ */ React.createElement("img", { src: window.mediaUrl(vImg.url), alt: "", style: { width: 40, height: 40, objectFit: "cover", borderRadius: 6, border: "1px solid var(--border)" } }) : /* @__PURE__ */ React.createElement("label", { title: "Ajouter une photo", style: { display: "flex", alignItems: "center", justifyContent: "center", width: 40, height: 40, border: "1px dashed var(--border2)", borderRadius: 6, cursor: "pointer", color: "var(--text-3)", fontSize: 16 } }, "+", /* @__PURE__ */ React.createElement("input", { type: "file", accept: "image/*", style: { display: "none" }, onChange: async (e) => {
      ...
      "button",
      {
        ...
        style: { position: "absolute", top: -6, right: -6, background: "var(--rose,#C68B6F)", color: "#fff", border: "none", borderRadius: "50%", width: 18, height: 18, cursor: "pointer", fontSize: 10, display: "flex", alignItems: "center", justifyContent: "center" }
      },
      "\u2715"
    )), /* @__PURE__ */ React.createElement("label", { style: { cursor: "pointer", display: "inline-flex", alignItems: "center", gap: 6, padding: "7px 14px", border: "1px dashed var(--border2)", borderRadius: 6, fontSize: 12, color: "var(--text-2)" } }, /* @__PURE__ */ React.createElement("svg", { width: "13", height: "13", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1.5" }, /* @__PURE__ */ React.createElement("path", { d: "M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" }), /* @__PURE__ */ React.createElement("polyline", { points: "17 8 12 3 7 8" }), /* @__PURE__ */ React.createElement("line", { x1: "12", y1: "3", x2: "12", y2: "15" })), vImagePreview ? "Changer la photo" : "Ajouter une photo", /* @__PURE__ */ React.createElement("input", { type: "file", accept: "image/*", style: { display: "none" }, onChange: (e) => {
      const file = e.target.files?.[0];
      if (!file) return;
      setVImageFile(file);
      setVImagePreview(URL.createObjectURL(file));
    } })))), /* @__PURE__ */ React.createElement("div", { className: "gap-row", style: { marginTop: 12 } }, /* @__PURE__ */ React.createElement("button", { className: "btn btn-ghost btn-sm", onClick: () => {
      setAddingVariant(false);
      setVForm(emptyVForm);
      setVImageFile(null);
      setVImagePreview("");
